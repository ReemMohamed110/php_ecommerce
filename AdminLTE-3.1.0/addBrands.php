...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-12">
        <form action="../controllers/cart/logic_brand.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-row my-3">
            <div class="col-2">
              <button class="btn btn-primary" name="page" value="index"> add brand </button>
            </div>
          </div>
        </form>
      </div>
